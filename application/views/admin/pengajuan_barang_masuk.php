                ...
                <?php 
                  ...
                  <tr>
                    <td class="text-center">
                      <button class="btn btn-sm m-0 btn-primary validasi" data-kode="<?= $pbm->kode_barang ?>" data-quantity="<?= $pbm->quantity ?>"><span class="fas fa-check" data-toggle="tooltip" data-placement="top" title="" data-original-title="Pindahkan ke Gudang"></span></button>
                    </td>
...
<div class="modal fade" id="modalValidasiBarangMasuk" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-modal="true">
  <div class="modal-dialog modal-sm cascading-modal" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header mb-0 light-blue darken-3 white-text">
        <h6 class="text-left">Pindahkan Barang Ke Gudang</h6>
